  ...
  return (
    <div className="h-full overflow-hidden flex flex-col p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
          <div className="text-lg sm:text-xl font-semibold text-white">Fornecedores</div>
          <div className="mt-1 text-sm text-slate-400">Gerencie fornecedores, compras e pagamentos</div>
        </div>
        <button
          type="button"
        ...
        <div className="p-3 sm:p-4">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-12 gap-3">
              ...
              <div className="text-sm text-slate-400">Carregando fornecedores...</div>
            </div>
          ) : rows.length ? (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1">
                      <div className="text-sm font-bold text-white truncate mb-1" title={r.name || ''}>
                        {r.name}
                      </div>
            ...
            <div className="text-center py-12 text-sm text-slate-400">Nenhum fornecedor encontrado.</div>
          )}
        </div>
      </div>
